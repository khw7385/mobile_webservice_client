...
public class MainActivity extends AppCompatActivity{
    ...
    private String uploadImage(String imageUri) throws IOException, JSONException{
        ...
        try {
            try {
                ...
                connection.setRequestProperty("Authorization", "JWT f866a2b8596b99cdfb9d2ff62d50018b6147f275");
        ...
        Log.e("LoginTest", "Failed to login");
